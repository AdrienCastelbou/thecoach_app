...
ActiveRecord::Schema.define(version: 2020_05_24_141638) do
  ...
  create_table "coach_spheres", force: :cascade do |t|
    t.bigint "coach_id"
    t.bigint "sphere_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["coach_id"], name: "index_coach_spheres_on_coach_id"
    t.index ["sphere_id"], name: "index_coach_spheres_on_sphere_id"
  end
